...
- **Order Processing (User Use Cases)**: Users can place orders, view their order history, and view items within their orders. They can:
  ...
  - Send a GET request to `/api/orders/{orderId}/items/{id}` to retrieve a specific order item within an order.
